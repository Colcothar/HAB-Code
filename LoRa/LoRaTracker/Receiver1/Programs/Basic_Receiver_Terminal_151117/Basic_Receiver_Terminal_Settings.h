...
#define Board_Definition "HAB2_Board_Definitions.h"    //define the board type to be used
...
//Tracker mode
const unsigned long TrackerMode_Frequency = 433400000;   

//Search mode
const unsigned long SearchMode_Frequency = 433300000;   

//Command mode
const unsigned long CommandMode_Frequency = 433500000;   
...
const int CalibrationOffset = 28900;
...
const char key0 = 'B';                       //Used to restrict access to some commands
const char key1 = 'A';
const char key2 = 'R';
const char key3 = 'T';
