...
#define TrackerMode_Frequency 433400000      //transmit frequency in hertz for tones
#define TrackerMode_Power 10
#define CalibrationOffset 28900                  //this is the LoRa module frequency calibration offset in Hertz
